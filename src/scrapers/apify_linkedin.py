...
def _parse_salary(s: str | None) -> tuple[Optional[int], Optional[int]]:
    ...
    # capture whether each number is currency-marked ($-prefixed
    # or K/M-suffixed). Prefer those; fall back to bare integers ONLY when
    ...
    _SALARY_CTX = (
        "usd", "salary", "compensation", "comp ", "/yr", "/year",
